...
#ifndef CATKIN_WS_FLUIDPRESSURETOMEAS_H
#define CATKIN_WS_FLUIDPRESSURETOMEAS_H
...
class FluidPressureToMeas {
public:
	// #############################
 	// @.@ Constructor
 	// #############################
	FluidPressureToMeas(ros::NodeHandle* nodehandle, ros::NodeHandle *nodehandle_private);
